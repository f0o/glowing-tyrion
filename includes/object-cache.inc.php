...
class LazyLoad extends ObjCache {
	...
	public function offsetGet( $obj ) {
		if( isset($this->data[$obj]['value']) ) {
			...
			$GLOBALS['_ObjCache'][$this->obj][$obj]['value'] = dbFetchRow($this->base,array($obj));
			if( sizeof($GLOBALS['_ObjCache'][$this->obj][$obj]['value']) == 1 ) {
				$GLOBALS['_ObjCache'][$this->obj][$obj]['value'] = array_pop($GLOBALS['_ObjCache'][$this->obj][$obj]['value']);
			}
			return $GLOBALS['_ObjCache'][$this->obj][$obj]['value'];
		}
	}
